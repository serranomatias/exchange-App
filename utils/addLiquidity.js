...
/*
  ...
  he wants to add to the exchange. If he is adding the liquidity after the initial liquidity
  has already been added the we calculate the Crypto Dev tokens he can add, given the Eth he
...
/*
  calculateCD calculate the CD tokens that need to be added to the liquidity
...
export const calculateCD = async (
    ...
    // The ratio we follow is (amount of Crypto Dev tokens to be added) / (Crypto Dev tokens balance) =
    // (Eth that would be added) / (Eth reserve in the contract).
    // So by maths we get (amount of Crypto Dev tokens to be added) = 
